...
public class SingleNodeReplicasetConfig extends AbstractReactiveMongoConfiguration {
...
/*╔═══════════════════════════════════════════════════╗
  ║  REPLICASET-SINGLE-NODE-MONGO-DB URL              ║
  ╠═══════════════════════════════════════════════════╩═════════════════╗
  ...
  ╚═════════════════════════════════════════════════════════════════════╝*/
    ...
    System.out.println("Connect RS-Single-Node ---> " + connection);
