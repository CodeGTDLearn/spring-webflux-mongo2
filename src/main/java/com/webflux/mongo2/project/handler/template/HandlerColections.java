...
@Component("handlerColections")
public class HandlerColections {
  ...
  public Mono<ServerResponse> addTemplMultCollections(ServerRequest request) {
    ...
    return ok()
         .contentType(JSON)
         .body(serviceColections.addTemplMultCollections(task), ProjectChild.class)
         .log();
  ...
  public Mono<ServerResponse> updateTemplMultCollections(ServerRequest request) {
    ...
    return ok()
         .contentType(JSON)
         .body(serviceColections.updateTemplMultCollections(task), ProjectChild.class)
         .log();
  ...
  public Mono<ServerResponse> checkCollectionsTemplate(ServerRequest request) {
    ...
    return ok()
         .contentType(JSON)
         .body(serviceColections.checkCollectionsTemplate(), String.class)
         .log();
  }
