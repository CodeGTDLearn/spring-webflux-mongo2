...
import com.webflux.mongo2.project.handler.template.HandlerColections;
...
@Configuration
public class RouterColections {

  private final MediaType JSON = MediaType.APPLICATION_JSON;

  @Bean
  public RouterFunction<ServerResponse> routesColections(HandlerColections handler) {
