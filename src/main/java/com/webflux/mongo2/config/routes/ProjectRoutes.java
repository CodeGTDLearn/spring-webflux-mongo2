package com.webflux.mongo2.config.routes;
...
public final class ProjectRoutes {
  ...
  public static final String PROJ_UPD= PROJ_ROOT + "/update";
  ...
  public static final String PROJ_COST_GREATER = PROJ_ROOT + "/find/ByEstimCostGreatThan";
