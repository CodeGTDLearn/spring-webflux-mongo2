...
public final class RoutesTemplCollections {
  ...
  public static final String TEMPL_ADD_CRIT_MULT_COL = TEMPL_ROOT + "/templ/createCritTemplMultCollect";
  public static final String TEMPL_UPD_CRIT_MULT_COL = TEMPL_ROOT + "/templ/updateCritTemplMultCollect";
}