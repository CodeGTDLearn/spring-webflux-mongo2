...
public class TestUtils {
       ...
       String... titleAndOthers)
  {
    ...
    var formattedTexts =
         Stream.of(titleAndOthers)
               .map(
                    item -> item.equals(title) && centralizeTitle ?
    ...
    var upperFace =
         upperLine(scale, cornersFormat, centerMarksFormat, horizontalLinesFormat);
    var divider =
         middleLine(scale, cornersFormat, centerMarksFormat, horizontalLinesFormat);
    var bottomFace =
         bottomLine(scale, cornersFormat, centerMarksFormat, horizontalLinesFormat);
    ...
    out.printf(textPreparation.toString(), formattedTexts);
  }
       ...
       Border line)
  {
    ...
    var baseline =
         generateLine('_', scale, borderStylingItems.get(3));

    return "%s%s%s%s%s\n"
         .formatted(
              borderStylingItems.get(0),
              baseline,
              borderStylingItems.get(2),
              baseline,
