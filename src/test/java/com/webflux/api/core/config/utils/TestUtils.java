...
public class TestUtils {
  ...
  private static class ConsolePanel {
    ...
    public static void panel(
      ...
      var formattedTexts = of(titleAndOthers).map(
                                                  item -> item.equals(title) && centralizeTitle ?
                                                       " ".repeat(marginTitle) + title : item)
                                             .map(item -> item.equals(
                                                  title) && uppercaseTitle ? item.toUpperCase() :
                                                  item)
                                             .toArray();

      var marginLimitedBySize = min(margin, scale);
    ...
    private static String middleLine(int scale, Border corner, Border centerMark,
                                     Border baseLine) {
